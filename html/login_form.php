...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form action="php/login.php" method="post" class="mt-8 space-y-6">
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
            <a href="html/register_form.php" class="font-medium text-indigo-600 hover:text-indigo-500">Create a new account </a> <!-- Corrected this link -->
        </p>
    </div>
</body>
</html>
